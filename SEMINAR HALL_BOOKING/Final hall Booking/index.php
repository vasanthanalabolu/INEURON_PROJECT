...
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><title>Hall Booking NIT-T</title>
...
<body>
	<div id="menu">
		...
		This Website focuses on BOOKING of Seminar Halls online as well as you can CHECK the availability of halls on a particular date. You need to fill
		the form which is available on this website and then take the printout of that form followed by submission of the form. You then needs to get 
		signature of your HOD and the Director of NITT. Finally submit the printout of the form in Admin.
		</div>
